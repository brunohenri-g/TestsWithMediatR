namespace MediatR
{
    ...
    /// <summary>
    /// <para>Extensions to scan for MediatR handlers and registers them.</para>
    /// <para>- Scans for any handler interface implementations and registers them as <see cref="ServiceLifetime.Transient"/></para>
    /// <para>- Scans for any <see cref="IRequestPreProcessor{TRequest}"/> and <see cref="IRequestPostProcessor{TRequest,TResponse}"/> implementations and registers them as scoped instances</para>
    /// <para>Registers <see cref="ServiceFactory"/> and <see cref="IMediator"/> as scoped instances</para>
